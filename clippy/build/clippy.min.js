...
clippy.load('Clippy', function(agent) {
      ...
      $(".clippy").css("z-index","1000")
      var action = $(".btn-primary").first()
      if(action.length==1) {
        console.log("Primary action")
        PDucky.moveTo(action.offset().left, action.offset().top+40)
        $(document).bind("click", function() {
          PDucky.play("GestureUp")
        });
      } else {
        console.log("No primary action")
        PDucky.moveTo(50, 50)
        $(document).bind("click", function() {
